...
export const metadata: Metadata = {
  title: "Contributors - DanCut",
  description:
    "Meet the amazing people who contribute to DanCut, the free and open-source video editor.",
  openGraph: {
    title: "Contributors - DanCut",
    description:
      "Meet the amazing people who contribute to DanCut, the free and open-source video editor.",
...
async function getContributors(): Promise<Contributor[]> {
  try {
    const response = await fetch(
      "https://api.github.com/repos/DanCut-app/DanCut/contributors?per_page=100",
      {
        headers: {
          Accept: "application/vnd.github.v3+json",
          "User-Agent": "DanCut-Web-App",
        },
          ...
          <div className="max-w-6xl mx-auto">
            ...
            {otherContributors.length > 0 && (
              <div>
                <div className="text-center mb-12">
                  ...
                  <p className="text-muted-foreground">
                    Everyone who makes DanCut better
                  </p>
                </div>
            ...
            {contributors.length === 0 && (
              <div className="text-center py-20">
                ...
                <Link
                  href="https://github.com/DanCut-app/DanCut/graphs/contributors"
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <div className="mt-32 text-center">
              <div className="max-w-2xl mx-auto">
                ...
                <p className="text-lg text-muted-foreground mb-10 leading-relaxed">
                  DanCut is built by developers like you. Every contribution,
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link
                    href="https://github.com/DanCut-app/DanCut/blob/main/.github/CONTRIBUTING.md"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
