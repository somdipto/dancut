...
export const metadata: Metadata = {
  title: "Privacy Policy - DanCut",
  description:
    "Learn how DanCut handles your data and privacy. Our commitment to protecting your information while you edit videos.",
  openGraph: {
    title: "Privacy Policy - DanCut",
    description:
      "Learn how DanCut handles your data and privacy. Our commitment to protecting your information while you edit videos.",
            ...
            <Card className="bg-background/80 backdrop-blur-xs border-2 border-muted/30">
              <CardContent className="p-8 text-base leading-relaxed space-y-8">
                <section>
                  ...
                  <p className="mb-4">
                    <strong>
                      DanCut processes all videos locally on your device.
                    </strong>{" "}
                ...
                <section>
                  ...
                  <p className="mb-4">
                    ...
                    understand how people use DanCut.
                  </p>
                  <p>
                ...
                <section>
                  ...
                  <p className="mb-4">
                    DanCut integrates with these services:
                  </p>
                  <ul className="list-disc pl-6 mb-4 space-y-2">
                    <li>
                ...
                <section>
                  ...
                  <p className="mb-4">
                    DanCut is completely open source. You can review our code,
