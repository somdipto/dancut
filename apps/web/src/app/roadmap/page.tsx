...
export const metadata: Metadata = {
  title: "Roadmap - DanCut",
  description:
    "See what's coming next for DanCut - the free, open-source video editor that respects your privacy.",
  openGraph: {
    title: "DanCut Roadmap - What's Coming Next",
    description:
      "See what's coming next for DanCut - the free, open-source video editor that respects your privacy.",
    type: "website",
    images: [
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
                What's coming next for DanCut (last updated: July 14, 2025)
              </p>
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-muted/20">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  DanCut is open source and built by the community. Every
