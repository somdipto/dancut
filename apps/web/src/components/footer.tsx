      ...
      <div className="max-w-5xl mx-auto px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-8">
          ...
          <div className="md:col-span-1 max-w-sm">
            <div className="flex justify-start items-center gap-2 mb-4">
              ...
              />
              <span className="font-bold text-lg">DanCut</span>
            </div>
          ...
          <div className="flex gap-12 justify-start items-start py-2">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link
                    href="https://github.com/DanCut-app/DanCut/blob/main/README.md"
                    className="text-muted-foreground hover:text-foreground transition-colors"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
        ...
        <div className="pt-2 flex flex-col md:flex-row justify-between items-start gap-4">
          <div className="flex items-center gap-4 text-sm text-muted-foreground">
            <span>© 2025 DanCut, All Rights Reserved</span>
          </div>
        </div>
      </div>
    </motion.footer>
